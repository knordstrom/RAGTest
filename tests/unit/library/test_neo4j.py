...
class TestMessage(unittest.TestCase):
    ...
    def test_collate_schedule_response(self):
        ...
        assert record['person']['name'] == 'Keith Nordstrom'
        assert record['person']['email'] == 'keith@cognimate.ai'
        assert record['person']['status'] == 'Unknown'
        assert record['organizer']['name'] == 'Pradeep Javangula'
        assert record['organizer']['email'] == 'pradeep@cognimate.ai'
        assert record['name'] == 'Kickoff Meeting'
